...
LINK_FLAGS := $(LDFLAGS) -lmpc $(shell PKG_CONFIG_PATH=$(PKG_CONFIG_PATH) pkg-config $(PKG_CONFIG_FLAGS) --libs $(LIBS) $(LIBS_GUI) $(LIBS_CL) | sed "$(PKG_CONFIG_SED)") $(LIBS_IMGUI) $(CLFLAGS)
