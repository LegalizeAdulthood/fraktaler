...
struct map
{
  ...
  void saveEXR(const std::filesystem::path &filename, const channel_mask_t channels, const int threads = 1, const std::string &metadata = "", const std::string &kf2plus_metadata = "") const;
};
