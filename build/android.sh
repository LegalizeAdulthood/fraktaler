...
wget -c https://www.libsdl.org/release/SDL2-2.0.22.tar.gz
...
cd ..
tar xaf mpfrc++-3.6.9.tar.gz
cp -avf mpreal-mpfrc-3.6.9/mpreal.h "${TOP}/android/armeabi-v7a/include"
cp -avf mpreal-mpfrc-3.6.9/mpreal.h "${TOP}/android/arm64-v8a/include"
cp -avf mpreal-mpfrc-3.6.9/mpreal.h "${TOP}/android/x86/include"
cp -avf mpreal-mpfrc-3.6.9/mpreal.h "${TOP}/android/x86_64/include"
...
tar xaf SDL2-2.0.22.tar.gz
cd SDL2-2.0.22/build-scripts
...
ln -fs "${TOP}/android/src/SDL2-2.0.22/include" app/jni/SDL/include
ln -fs "${TOP}/android/src/SDL2-2.0.22/src" app/jni/SDL/src
ln -fs "${TOP}/android/src/SDL2-2.0.22/android-project/app/src/main/java/org" app/src/main/java/org
else
cd "${TOP}/android/src/SDL2-2.0.22/build/uk.co.mathr.fraktaler.v3"
