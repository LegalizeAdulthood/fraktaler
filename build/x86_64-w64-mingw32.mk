...
CPPFLAGS += -D__USE_MINGW_ANSI_STDIO=1 -DWINVER=0x501 -D_WIN32_WINNT=0x501 -I$(WIN)/include -I$(WIN)/include/OpenEXR -I$(WIN)/src/glew-2.1.0/include -DDEFAULT_LINKAGE_HAS_UNDERSCORE=0 -DGLEW_STATIC -DHAVE_GLEW -DHAVE_GLDEBUG -DHAVE_EXR
