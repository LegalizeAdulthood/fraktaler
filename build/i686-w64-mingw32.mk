...
CPPFLAGS += -D__USE_MINGW_ANSI_STDIO=1 -DWINVER=0x501 -D_WIN32_WINNT=0x501 -I$(WIN)/include -I$(WIN)/include/OpenEXR $(EXR) -I$(CLEWPREFIX)/include -Dclew_STATIC -DHAVE_CLEW -DHAVE_CL -DHAVE_GUI
